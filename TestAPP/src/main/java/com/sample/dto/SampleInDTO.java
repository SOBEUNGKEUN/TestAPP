...
public class SampleInDTO extends DataObject implements Serializable, Cloneable {
    ...
    @Override
    public Object clone() {
    	SampleInDTO copyObj = new SampleInDTO();
    	copyObj.clone(this);
    	return copyObj;
    }
    
    public void clone(Object _sampleInDTO){
    	if (this == _sampleInDTO)
    		return;
    		
    	SampleInDTO __sampleInDTO = (SampleInDTO) _sampleInDTO;
    	this.setEmpno(__sampleInDTO.getEmpno());
    	this.setEname(__sampleInDTO.getEname());
    }
