...
public class q01InDTO extends DataObject implements Serializable, Cloneable {
    ...
    @Override
    public Object clone() {
    	q01InDTO copyObj = new q01InDTO();
    	copyObj.clone(this);
    	return copyObj;
    }
    
    public void clone(Object _q01InDTO){
    	if (this == _q01InDTO)
    		return;
    		
    	q01InDTO __q01InDTO = (q01InDTO) _q01InDTO;
    	this.setEmpno(__q01InDTO.getEmpno());
    	this.setEname(__q01InDTO.getEname());
    }
